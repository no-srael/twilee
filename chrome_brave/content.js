...
// Load settings from storage
  function loadSettings() {
    chrome.storage.sync.get(['settings', 'replaceAllWords'], (result) => {
      if (result.settings) {
        ...
        fetch(chrome.runtime.getURL('default_twilee_settings.json'))
  ...
  function updateToggleSwitch() {
    ...
    toggleSwitch.addEventListener('click', (event) => {
      ...
      updateToggleSwitch();
      chrome.storage.sync.set({ replaceAllWords });
    });
